...
model2 = optimal_Net(nin=nin,nh0=nh0,nout=nout)

print(str(model2))



opt = torch.optim.SGD(model2.parameters(), 0.030151700312434134, weight_decay=1.829053506773946e-07)
